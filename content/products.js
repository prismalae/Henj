...
export const fruitsVegetables = [
  ...
  {
    name: 'Bananas',
    description: 'Kerala nendran and yellow table bananas, cut to the ripening stage you need.',
    image: '/img/products/bananas.png',
    specs: {
      Origin: 'India (Kerala, Tamil Nadu)',
      Varieties: 'Nendran, robusta, poovan, red banana',
      Packing: '13 / 18 kg cartons, hands or clusters',
