...
export default function CtaBand({
  ...
  body = <>Looking for a reliable partner for your business? Partner with <strong className="co co--onDark">HENJ Trading LLC</strong> for quality you can trust and service you can rely on.</>,
  action = 'Enquire Now',
